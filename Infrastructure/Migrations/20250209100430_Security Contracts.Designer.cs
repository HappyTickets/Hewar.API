...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250209100430_Security Contracts")]
    partial class SecurityContracts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.FacilityAggregate.SecurityContract", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.Entities.FacilityAggregate.SecurityContract", b =>
                {
                    b.HasOne("Domain.Common.Address", "Address")
                        .WithOne()
                        .HasForeignKey("Domain.Entities.FacilityAggregate.SecurityContract", "AddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.FacilityAggregate.Facility", "Facility")
                        .WithMany("SecurityContracts")
            ...
            modelBuilder.Entity("Domain.Entities.FacilityAggregate.Facility", b =>
                {
                    ...
                    b.Navigation("SecurityContracts");

...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250213055547_Seperate Signatures")]
    partial class SeperateSignatures
    {
        /// <inheritdoc />
                    ...
                    b.OwnsMany("Domain.Common.Media", "Medias", b1 =>
                        {
                            ...
                            SqlServerPropertyBuilderExtensions.UseIdentityColumn(b1.Property<int>("Version"));
                    ...
                    b.OwnsMany("Domain.Common.Media", "Medias", b1 =>
                        {
                            ...
                            b1.HasKey("TicketMessageId", "Version");
            ...
            modelBuilder.Entity("Domain.Entities.GuardAggregate.Guard", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.IdentityAggregate.ApplicationUser", null)
                        .WithOne()
                        .HasForeignKey("Domain.Entities.GuardAggregate.Guard", "Version")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

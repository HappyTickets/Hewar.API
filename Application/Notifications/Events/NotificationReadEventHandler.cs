...
namespace Application.Notifications.Events
{
    internal class NotificationReadEventHandler : INotificationHandler<NotificationRead>
    {
        ...
        {
            await _notificationService.NotifyUserNotificationReadAsync(notification.Notification.RecipientId, notification.Notification.RecipientType.ToString(), notification.Notification.Id);
        }
    }
}
